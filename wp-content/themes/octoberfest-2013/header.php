...
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/jquery-latest.min.js"></script>
...
<div id="contentWrapper">
	...
	<div id="topCartButtons">
		<a id="topCartArrows" href="<?php echo home_url(); ?>/about/home/">Home Page</a>
		<a id="topCartArrows" href="<?php echo home_url(); ?>/event-registration/?regevent_action=show_shopping_cart">View Cart</a>
	</div>
	<div id="buttonHeader">
